    ...
    <div className="  p-8">
      <div className=" flex flex-col  mx-auto">
        ...
        {/* <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          <StatsCard title="Total Users" value={342} icon={<Users />} bgColor="bg-blue-100" iconColor="text-blue-600" />
          <StatsCard title="Active Users" value={241} icon={<UserCheck />} bgColor="bg-green-100" iconColor="text-green-600" />
          <StatsCard title="Pro Users" value={133} icon={<Award />} bgColor="bg-yellow-100" iconColor="text-yellow-600" />
          <StatsCard title="Suspended" value={12} icon={<UserX />} bgColor="bg-red-100" iconColor="text-red-600" />
        </div> */}
        <StatsCards/>
            ...
            <table className="w-full">
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {filteredUsers.map((user, index) => (
                  <UserRow key={user.id} user={user} avatarColor={avatarColors[index % avatarColors.length]} />
                ))}
              </tbody>
            </table>
          </div>
