...
const ListeningPractice: React.FC = ({continueCallback}) => {
...
const handleDictationContinue = () => {
  setPhase('sentence');
  setCurrentExercise(currentExercise + 1); // increment for sentence phase
};
...
const handleSentenceComplete = () => {
  setPhase('complete');
  setCurrentExercise(currentExercise + 1); // increment for complete
};
