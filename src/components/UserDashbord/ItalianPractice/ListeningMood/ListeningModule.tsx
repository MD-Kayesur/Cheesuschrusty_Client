...
//   const handleDictationContinue = () => setCurrentStep('ordering');
//   const handleOrderingContinue = () => setCurrentStep('complete');
...
//         <div>
//              {currentStep === 'practice' && <ListeningPractice continueCallback={() => setCurrentStep('dictation')} />}
//       {currentStep === 'dictation' && <ListeningDictation continueCallback={handleDictationContinue} />}
//       {currentStep === 'ordering' && <SentenceOrdering continueCallback={handleOrderingContinue} />}
//       {currentStep === 'complete' && <ListeningPracticeComplete />}
//         </div>   
//      </div>
//     </>
