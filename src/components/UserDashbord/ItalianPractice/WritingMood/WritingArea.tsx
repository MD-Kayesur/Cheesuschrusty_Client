  ...
  <div className="p-6">
    <div className="mb-4">
      ...
      <textarea
        ...
        className="w-full h-48 p-4 border-2 border-blue-300 rounded-lg resize-none focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-gray-800 placeholder-gray-400"
      />
    </div>
  </div>
);
